...
data class MeterEntity(
    ...
    companion object {
        ...
        val DEF_PASSPORT_DATE: OffsetDateTime = OffsetDateTime.now().minusMonths(7)
        ...
        fun defaultMeter(
            ...
            maxValue: BigDecimal = BigDecimal("9999.999"),
        ...
        fun gasMeter(
            ctx: Context, payerId: UUID, currDate: OffsetDateTime? = DEF_PASSPORT_DATE,
